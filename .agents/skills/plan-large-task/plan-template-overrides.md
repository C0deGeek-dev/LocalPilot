...
> plan's local `tasks/<name>/` folder.

Disposable timing for this repo: maintainers archive or remove local plan files
outside the distribution after acceptance; shipped code, identifiers, and
commits stay plan-agnostic.
