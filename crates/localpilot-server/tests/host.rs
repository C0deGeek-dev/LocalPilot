//! Per-session host behaviour: multi-client event fanout, lock-free cancel and
//! steer that reach an in-flight turn without the runtime mutex, and a two-client
//! control-routed end-to-end turn.
//!
...
// --- control routing + two-client end-to-end -------------------------------
