...
//! `PROGRESS.md`, using original Unshackled prompts.
//!
...
use unshackled_llm::{ModelEvent, ModelProvider, ModelRequest};

use crate::brief::Brief;
use crate::error::HarnessError;
use crate::progress::Progress;

/// The original Unshackled intake prompt.
...
/// The original Unshackled planner prompt.
