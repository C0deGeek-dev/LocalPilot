...
pub enum WireProtocol {
    ...
    Mcp {
        ...
        approvals: bool,
        /// Give up after this long with no client message. `None` waits
        /// forever — the old behaviour, and the one that let an abandoned
        /// client hold a server (and the binary) open for days.
