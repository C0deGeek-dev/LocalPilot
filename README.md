...
<div align="center">
  ...
  <p>
    <img alt="version 2.0.1" src="https://img.shields.io/badge/version-2.0.1-7da7ff?style=flat-square">
...
| **Status** | `2.0.1` stable; public CLI, config, and provider contract follow SemVer |
