...
<div align="center">
  ...
  <p>
    <img alt="version 2.6.0" src="https://img.shields.io/badge/version-2.6.0-7da7ff?style=flat-square">
...
| **Status** | `2.6.0` stable; public CLI, config, and provider contract follow SemVer |
